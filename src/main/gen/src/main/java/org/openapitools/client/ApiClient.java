...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8080/EntJavaTeamProject_war/services";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8080/EntJavaTeamProject_war/services
